  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background">
      <section className="relative min-h-screen px-4 py-6">
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-6rem)] max-w-7xl items-center gap-10 py-12 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="max-w-2xl">
            <h1 className="text-5xl font-semibold md:text-7xl">Money clarity without the accounting fog</h1>
            ...
            <div className="mt-10 grid gap-3 sm:grid-cols-3">
              {["TT$42k tracked", "43% saved", "4 bills ahead"].map((item) => (
          ...
          <div className="relative">
            <div className="absolute -inset-8 rounded-[2rem] bg-[conic-gradient(from_90deg,var(--chart-1),var(--chart-2),transparent,var(--chart-1))] opacity-30 blur-3xl" aria-hidden="true" />
      ...
      <section id="privacy" className="mx-auto max-w-7xl px-4 py-20">
        <Card className="glass-panel overflow-hidden border-primary/20 shadow-2xl shadow-primary/10">
          <CardContent className="grid gap-8 p-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Version 1 keeps imports manual and transparent. Financial Tracks never stores bank login details, and CSV rows are saved only after you preview and confirm them.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {["No bank credentials stored", "Manual CSV control", "Protected dashboard pages", "User-scoped PostgreSQL data"].map((item) => (
